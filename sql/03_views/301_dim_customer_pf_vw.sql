...
DROP VIEW IF EXISTS dim_customer_pf_vw;

CREATE OR REPLACE VIEW dim_customer_pf_vw AS
SELECT
    c.customer_id,
    pf.cpf,
    pf.nome_completo,
    pf.renda_mensal_declarada,
    c.status_cliente,
    c.kyc_status,
    c.dt_cadastro,
    addr.cidade       AS city,
...
SHOW CREATE VIEW dim_customer_pf_vw;
DESCRIBE dim_customer_pf_vw;
SELECT * FROM dim_customer_pf_vw;